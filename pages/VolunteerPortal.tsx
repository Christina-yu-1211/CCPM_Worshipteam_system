                        ...
                        <div className="bg-blue-50/50 p-4 sm:p-6 rounded-2xl space-y-4 border border-blue-100 overflow-hidden">
                           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                              <div className="min-w-0">
                                 ...
                                 <select className={`w-full block h-12 px-4 rounded-xl border-2 text-base bg-white focus:ring-0 outline-none box-border ${errors.arrivalLocation ? 'border-red-300' : 'border-blue-100 focus:border-blue-500'}`}
                              ...
                              <div className="min-w-0">
                                 ...
                                 <input type="time" className={`w-full block h-12 px-4 rounded-xl border-2 text-base bg-white focus:ring-0 outline-none box-border ${errors.arrivalTime ? 'border-red-300' : 'border-blue-100 focus:border-blue-500'}`}
                        ...
                        <div className="bg-orange-50/50 p-4 sm:p-6 rounded-2xl space-y-4 border border-orange-100 overflow-hidden">
                           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                              <div className="min-w-0">
                                 ...
                                 <select className={`w-full block h-12 px-4 rounded-xl border-2 text-base bg-white focus:ring-0 outline-none box-border ${errors.departureLocation ? 'border-red-300' : 'border-orange-100 focus:border-orange-500'}`}
                              ...
                              <div className="min-w-0">
                                 ...
                                 <input type="time" className={`w-full block h-12 px-4 rounded-xl border-2 text-base bg-white focus:ring-0 outline-none box-border ${errors.departureTime ? 'border-red-300' : 'border-orange-100 focus:border-orange-500'}`}
